...
CREATE TABLE [PropertyInformation] (
    ...
    CONSTRAINT [FK_PropertyInformation_BorrowerInformation_BorrowerId] FOREIGN KEY ([BorrowerId]) REFERENCES [BorrowerInformation] ([BorrowerId]) ON DELETE CASCADE
);
...
CREATE TABLE [LegalDocuments] (
    ...
    [PropertyApplicantId] int NULL,
    CONSTRAINT [PK_LegalDocuments] PRIMARY KEY ([ApplicationNo]),
    CONSTRAINT [FK_LegalDocuments_PropertyInformation_PropertyApplicantId] FOREIGN KEY ([PropertyApplicantId]) REFERENCES [PropertyInformation] ([ApplicantId]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_LegalDocuments_PropertyApplicantId] ON [LegalDocuments] ([PropertyApplicantId]);

GO

CREATE INDEX [IX_PropertyInformation_BorrowerId] ON [PropertyInformation] ([BorrowerId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221211154609_FinalMig', N'3.1.30');
